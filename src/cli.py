...
def get_argparser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="CLI application for CatalanChess Backend")
...
async def cli() -> None:
    ...
    pg_session_manager: "sessionmaker[AsyncSession]" = create_new_pg_session_maker(db_url=settings.db.pg_connection_url)
